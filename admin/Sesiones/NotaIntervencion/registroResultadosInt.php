        ...
        <div class="">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2>Lista de Pacientes con procedimientos pendientes</h2>

                        <div class="clearfix"></div>
                    </div>

                    <div class="x_content">
                        <form id="frmExpediente" action="../../Sesiones/NotaIntervencion/resultadosIntervencion.php" method="post">
                                ...
                                if($arrPaciente != null){
                                    foreach($arrPaciente as $vRT){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="submit" value="Registrar resultados de Procedimiento" class=" btn btn-primary" onClick="txtExpediente.value='<?php echo $vRT->getExpediente()->getNumero();?>';txtOp.value='r';" >
                                            </td>
                                        </tr>
                                        <?php
                                    }
