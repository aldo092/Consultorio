        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <form action="../../Controllers/ctrlAseguradora.php" method="post"  data-parsley-validate class="form-horizontal form-label-left" >

                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nombre">Nombre de la aseguradora<span class="required">*</span>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="telefono" class="control-label col-md-3 col-sm-3 col-xs-12">Telefono<span class="requiered">*</span> </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label for="direccion" class="control-label col-md-3 col-sm-3 col-xs-12">Dirección<span class="requiered">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
